...
#     # cv2.imshow('last_frame', captured_frame)
...
# # Call the function to turn on the webcam and capture a frame
# # captured_frame = turn_on_webcam()
# cap = cv2.VideoCapture(0)
# while True:
#     # Capture frame-by-frame
#     ret, frame = cap.read()
